...
<html>
    <head>
        ...
        <meta name="description" content="<?php print $user['username']; ?>'s userprofile on wispr.">
                  ...
                  <div class="col s12 m4">
                    <div class="card">
                      <div class="card-image">
                          ...
                          <img src="<?php echo $propic;?>" alt="Display Picture of <?php echo htmlspecialchars($dispname,ENT_QUOTES);?>">
                        </a>
