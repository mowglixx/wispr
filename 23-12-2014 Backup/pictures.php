...
<h1><?php 
	...
	else{echo '<a href="/' . $viewprofile['username'] . '">' . $dispname . '&apos;s</a>';};?> Pictures <small><?php if($getid == $profile['username'] && $pic['imgname'] !== $viewprofile['profilepic']): ?>
		<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#uploadpic">Upload a Picture!</button>
	<?php endif;?></small></h1>
<?php if(empty($viewid)): ?>
<ol class="breadcrumb">
...
<div class="row">
	...
	<div class="col-md-4">
			<div class="thumbnail">
		<a href="?id=<?php echo $getid; ?>&viewpic=<?php echo $pic['pic_id']; ?>"><img src="<?php echo $pic['imgname'];?>" class="img-responsive img-rounded propic-pro" alt="picture uploaded by <?php echo htmlspecialchars($dispname, ENT_QUOTES);?> Caption = <?php echo htmlspecialchars($pic['caption'], ENT_QUOTES); ?>"></a>
		<div class="caption">
		<p><?php echo $pic['caption'];?>&nbsp;</p>
		<?php if($getid == $profile['username'] && $pic['imgname'] !== $viewprofile['profilepic']): ?>
		<div class="container-fluid">
		<a class="btn btn-info pull-left" href="mk-propic.php?id=<?php echo $pic['pic_id'];?>"><span class="glyphicon glyphicon-user"></span> Make Profile Pic</a> <a class="btn btn-danger pull-right" href="del-propic.php?id=<?php echo $pic['pic_id'];?>"><span class="glyphicon glyphicon-trash"></span> Delete</a></div>
		<?php endif;?>
		</div>
		</div>
		</div>
...
<ol class="breadcrumb">
	<li><a href="pictures.php?id=<?php echo $getid; ?>"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
	<li><a href="home.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	<li><a href="/<?php echo $getid; ?>"><?php echo $dispname; ?></a></li>
	<li><a href="pictures.php?id=<?php echo $getid; ?>">Pictures</a></li>
	<li class="active"><?php if(empty($viewpic['caption'])){echo "This picture";}else{echo $viewpic['caption'];}?></li>
</ol>
<img alt="picture uploaded by <?php echo htmlspecialchars($dispname, ENT_QUOTES);?> Caption = <?php echo htmlspecialchars($viewpic['caption'], ENT_QUOTES); ?>" class="img-responsive img800 center-block" src="<?php echo $viewpic['imgname'];?>">
...
<!-- Upload pictures  -->
<div class="modal fade" id="uploadpic" tabindex="-1" role="dialog" aria-labelledby="Change Profile Pic" aria-hidden="true">
